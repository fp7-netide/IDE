...
class VerHub implements IVerHub, Runnable {

	private List<IVerHubListener> listeners = newArrayList
	...
	override register(IVerHubListener listener) {
		listeners.add(listener)
	}

	override remove(IVerHubListener listener) {
