...
class RyuShimStarter extends ControllerStarter {
	...
	new(ILaunchConfiguration configuration, Controller controller, IProgressMonitor monitor) {
		super(NetIDE.CONTROLLER_RYU + " " + NetIDE.CONTROLLER_SHIM, configuration, controller, monitor)
	}
	...
	override getCommandLine() {
		return String.format("sudo ryu-manager --ofp-tcp-listen-port %s %sryu-shim/ryu-shim.py", port, this.enginePath)
	}
