...
public class ParametersFactoryImpl extends EFactoryImpl implements ParametersFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ParametersPackage.PARAMETER_SPECIFICATION: return createParameterSpecification();
			case ParametersPackage.TYPE: return createType();
			case ParametersPackage.COMPOSITE_TYPE: return createCompositeType();
			case ParametersPackage.BASIC_TYPE: return createBasicType();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ParametersPackage.ATOMIC_TYPE:
