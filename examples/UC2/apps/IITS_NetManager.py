...
class IITS_NetManager(app_manager.RyuApp):
    ...
    def forward_packet(self, msg):
        ...
        datapath.send_msg(out)
        #print "ip packet forwarded"

    def add_flow(self, datapath, dst, actions):
        ofproto = datapath.ofproto

        match = datapath.ofproto_parser.OFPMatch(
            dl_type=ether_types.ETH_TYPE_IP, nw_dst=IPv4Address(dst))
    ...
    def add_priority_flow(self, datapath, dst, out_port):
    ...
    def del_priority_flow(self, datapath, dst, out_port):
